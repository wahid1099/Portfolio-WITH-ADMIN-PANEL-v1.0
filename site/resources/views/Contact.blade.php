    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <hr>
                <p class="footer-text"><i class="fas fa-map-marker-alt"></i> শেখেরটেক ৮ মোহাম্মদপুর, ঢাকা <i class="fas ml-2 fa-phone"></i>   01879439753 <i class="fas ml-2 fa-envelope"></i>  wahidahmed890@gmail.com</p>
